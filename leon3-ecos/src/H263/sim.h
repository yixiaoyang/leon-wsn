 ...
 */
#define IF_ON_PC	NO
#define IF_COMPUTE_SNR	YES	

#define MEM_BUFFER_SIZE	(1024*1024*40)
#define MEM_OUT_SIZE	(1024*1024)
struct _buffer{
	//unsigned char stream_input[MEM_BUFFER_SIZE];
	unsigned char* stream_input;	
	unsigned char stream_output[MEM_OUT_SIZE];
