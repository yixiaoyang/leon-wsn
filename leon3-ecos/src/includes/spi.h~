 ...
 * spi.h
 *
 *  Created on: 2011-2-22 LiangShuang
 *	Modify	on:	2012-2-29 xiaoyang.yi
 *      Author: xiaoyang.yi
 */
 ...
 * AUX0_GPIO[12-16]=> VGA
 */
//#define SPI2_CS   		(1 << 0)		//CS Always Enable
#define SPI2_MOSI   		( 1 << 0) //gpio8 // 		//GPIO_0[11],PORTB[3]
#define SPI2_MISO   		( 1 << 4)		//GPIO_0[12],PORTB[4]
#define SPI2_CLK    		( 1 << 5) 		//GPIO_0[13],PORTB[5]
...
int8u_t spi_wbyte(int8u_t val);
int8u_t spi_rbyte(int8u_t val);
int8u_t spi_wbuf(int8u_t* buf, int32u_t len);
